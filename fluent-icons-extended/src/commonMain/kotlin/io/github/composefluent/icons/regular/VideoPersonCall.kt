...
public val Icons.Regular.VideoPersonCall: ImageVector
    get() {
        if (_videoPersonCall != null) {
            return _videoPersonCall!!
        }
        _videoPersonCall = fluentIcon(name = "Regular.VideoPersonCall") {
            fluentPath {
                moveTo(22.0f, 6.25f)
                ...
                curveToRelative(0.4f, -0.39f, 0.94f, -0.6f, 1.5f, -0.6f)
