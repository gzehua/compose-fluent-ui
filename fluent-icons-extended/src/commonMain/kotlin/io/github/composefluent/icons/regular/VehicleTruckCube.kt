...
public val Icons.Regular.VehicleTruckCube: ImageVector
    get() {
        if (_vehicleTruckCube != null) {
            return _vehicleTruckCube!!
        }
        _vehicleTruckCube = fluentIcon(name = "Regular.VehicleTruckCube") {
            fluentPath {
                moveTo(1.0f, 8.57f)
                lineTo(1.0f, 4.43f)
                ...
                curveToRelative(0.0f, 0.39f, 0.3f, 0.7f, 0.67f, 0.75f)
                ...
                arcTo(2.5f, 2.5f, 0.0f, false, false, 11.55f, 3.0f)
                ...
                arcToRelative(3.0f, 3.0f, 0.0f, false, true, -5.91f, 0.0f)
                arcTo(2.25f, 2.25f, 0.0f, false, true, 2.0f, 17.24f)
                verticalLineToRelative(-6.13f)
                lineToRelative(1.5f, 0.75f)
                close()
                moveTo(16.5f, 16.4f)
                curveToRelative(0.61f, 0.36f, 1.09f, 0.92f, 1.33f, 1.6f)
