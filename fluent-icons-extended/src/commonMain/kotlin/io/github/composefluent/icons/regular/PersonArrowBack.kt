...
public val Icons.Regular.PersonArrowBack: ImageVector
    get() {
        if (_personArrowBack != null) {
            return _personArrowBack!!
        }
        _personArrowBack = fluentIcon(name = "Regular.PersonArrowBack") {
            fluentPath {
                moveTo(11.31f, 15.5f)
                ...
                arcToRelative(6.5f, 6.5f, 0.0f, false, true, -0.92f, -1.37f)
                curveToRelative(-0.52f, 0.08f, -1.08f, 0.11f, -1.68f, 0.11f)
