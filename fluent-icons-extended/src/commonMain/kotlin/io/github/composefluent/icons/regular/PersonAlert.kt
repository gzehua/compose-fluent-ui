...
public val Icons.Regular.PersonAlert: ImageVector
    get() {
        if (_personAlert != null) {
            return _personAlert!!
        }
        _personAlert = fluentIcon(name = "Regular.PersonAlert") {
            fluentPath {
                moveTo(17.76f, 14.0f)
                curveTo(19.0f, 14.0f, 20.0f, 15.0f, 20.0f, 16.25f)
                verticalLineToRelative(0.57f)
                curveToRelative(0.0f, 0.9f, -0.31f, 1.76f, -0.9f, 2.44f)
                ...
                curveToRelative(0.55f, -0.26f, 0.87f, -0.82f, 0.86f, -1.4f)
                curveToRelative(2.23f, -0.16f, 3.87f, -0.89f, 4.96f, -2.17f)
                ...
                arcToRelative(4.97f, 4.97f, 0.0f, false, false, -0.39f, -1.5f)
