...
public val Icons.Regular.Umbrella: ImageVector
    get() {
        if (_umbrella != null) {
            return _umbrella!!
        }
        _umbrella = fluentIcon(name = "Regular.Umbrella") {
            fluentPath {
                ...
                close()
                moveTo(3.79f, 9.28f)
                curveTo(4.71f, 6.18f, 7.74f, 3.5f, 12.0f, 3.5f)
                curveToRelative(4.26f, 0.0f, 7.29f, 2.68f, 8.2f, 5.78f)
                arcToRelative(3.94f, 3.94f, 0.0f, false, false, -2.03f, -0.6f)
                curveToRelative(-1.18f, 0.0f, -2.12f, 0.57f, -2.72f, 1.09f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, -0.37f, 0.33f)
                lineToRelative(-0.36f, -0.33f)
                arcTo(4.27f, 4.27f, 0.0f, false, false, 12.0f, 8.67f)
                curveToRelative(-1.17f, 0.0f, -2.11f, 0.58f, -2.72f, 1.1f)
                curveToRelative(-0.13f, 0.11f, -0.26f, 0.22f, -0.36f, 0.33f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, -0.37f, -0.33f)
                arcToRelative(4.27f, 4.27f, 0.0f, false, false, -2.72f, -1.1f)
                curveToRelative(-0.8f, 0.0f, -1.49f, 0.28f, -2.04f, 0.6f)
                close()
                moveTo(12.0f, 11.18f)
