...
public val Icons.Regular.TagReset: ImageVector
    get() {
        if (_tagReset != null) {
            return _tagReset!!
        }
        _tagReset = fluentIcon(name = "Regular.TagReset") {
            fluentPath {
                moveTo(22.0f, 4.25f)
                ...
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, -0.49f, -1.64f)
                ...
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, 1.64f, 0.49f)
