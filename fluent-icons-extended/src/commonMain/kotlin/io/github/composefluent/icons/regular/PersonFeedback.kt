...
public val Icons.Regular.PersonFeedback: ImageVector
    get() {
        if (_personFeedback != null) {
            return _personFeedback!!
        }
        _personFeedback = fluentIcon(name = "Regular.PersonFeedback") {
            fluentPath {
                moveTo(14.77f, 12.4f)
                ...
                curveToRelative(0.0f, 0.1f, -0.02f, 1.35f, 0.9f, 2.31f)
                curveToRelative(0.76f, 0.79f, 1.97f, 1.19f, 3.6f, 1.19f)
                curveToRelative(1.63f, 0.0f, 2.85f, -0.41f, 3.61f, -1.21f)
                curveToRelative(0.91f, -0.95f, 0.9f, -2.2f, 0.9f, -2.26f)
                curveToRelative(0.0f, -0.31f, -0.24f, -0.54f, -0.5f, -0.54f)
                lineTo(4.0f, 16.49f)
                verticalLineToRelative(0.01f)
                close()
            }
