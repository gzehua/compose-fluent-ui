...
public val Icons.Regular.StarArrowRightStart: ImageVector
    get() {
        if (_starArrowRightStart != null) {
            return _starArrowRightStart!!
        }
        _starArrowRightStart = fluentIcon(name = "Regular.StarArrowRightStart") {
            fluentPath {
                moveTo(10.79f, 3.1f)
                ...
                lineToRelative(-3.95f, -2.08f)
                curveToRelative(0.14f, -0.5f, 0.22f, -1.02f, 0.24f, -1.57f)
                lineToRelative(4.14f, 2.18f)
                ...
                lineToRelative(-5.05f, 0.74f)
                lineToRelative(1.16f, 1.13f)
                curveToRelative(-0.53f, 0.14f, -1.04f, 0.35f, -1.51f, 0.61f)
                lineToRelative(-0.91f, -0.88f)
