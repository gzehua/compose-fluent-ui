...
public val Icons.Regular.PersonCall: ImageVector
    get() {
        if (_personCall != null) {
            return _personCall!!
        }
        _personCall = fluentIcon(name = "Regular.PersonCall") {
            fluentPath {
                moveTo(17.38f, 15.5f)
                arcToRelative(2.2f, 2.2f, 0.0f, false, true, -0.23f, -1.5f)
                lineTo(6.25f, 14.0f)
                ...
                arcToRelative(2.26f, 2.26f, 0.0f, false, true, 0.0f, -1.5f)
                curveToRelative(-0.36f, 0.03f, -0.74f, 0.04f, -1.13f, 0.04f)
