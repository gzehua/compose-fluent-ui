...
public val Icons.Regular.VehicleTruckProfile: ImageVector
    get() {
        if (_vehicleTruckProfile != null) {
            return _vehicleTruckProfile!!
        }
        _vehicleTruckProfile = fluentIcon(name = "Regular.VehicleTruckProfile") {
            fluentPath {
                moveTo(4.25f, 3.0f)
                ...
                close()
                moveTo(17.83f, 18.0f)
                arcToRelative(3.01f, 3.01f, 0.0f, false, false, -1.33f, -1.6f)
                ...
                close()
                moveTo(15.0f, 16.0f)
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, -2.83f, 2.0f)
                lineTo(9.83f, 18.0f)
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, -5.66f, 0.0f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, -0.67f, -0.75f)
                verticalLineToRelative(-12.0f)
                curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f)
                horizontalLineToRelative(10.0f)
