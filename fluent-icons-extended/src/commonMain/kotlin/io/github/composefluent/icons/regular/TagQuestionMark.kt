...
public val Icons.Regular.TagQuestionMark: ImageVector
    get() {
        if (_tagQuestionMark != null) {
            return _tagQuestionMark!!
        }
        _tagQuestionMark = fluentIcon(name = "Regular.TagQuestionMark") {
            fluentPath {
                moveTo(19.75f, 2.0f)
                ...
                arcToRelative(6.47f, 6.47f, 0.0f, false, false, -1.43f, -0.7f)
                lineToRelative(0.4f, -0.4f)
                curveToRelative(0.33f, -0.32f, 0.51f, -0.76f, 0.51f, -1.23f)
                lineTo(20.5f, 4.25f)
                ...
                lineTo(9.0f, 19.45f)
                curveToRelative(0.64f, 0.64f, 1.64f, 0.68f, 2.33f, 0.13f)
                curveToRelative(0.16f, 0.49f, 0.39f, 0.95f, 0.65f, 1.38f)
