...
public val Icons.Regular.ReceiptCube: ImageVector
    get() {
        if (_receiptCube != null) {
            return _receiptCube!!
        }
        _receiptCube = fluentIcon(name = "Regular.ReceiptCube") {
            fluentPath {
                moveTo(5.0f, 6.25f)
                ...
                arcToRelative(2.5f, 2.5f, 0.0f, false, false, -1.5f, 0.16f)
                lineTo(5.0f, 6.25f)
                close()
                moveTo(14.25f, 13.0f)
                horizontalLineToRelative(-3.66f)
                lineToRelative(-2.43f, -1.21f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, 0.59f, -0.29f)
