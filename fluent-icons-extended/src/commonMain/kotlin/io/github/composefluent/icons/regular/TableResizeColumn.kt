...
public val Icons.Regular.TableResizeColumn: ImageVector
    get() {
        if (_tableResizeColumn != null) {
            return _tableResizeColumn!!
        }
        _tableResizeColumn = fluentIcon(name = "Regular.TableResizeColumn") {
            fluentPath {
                ...
                arcToRelative(1.74f, 1.74f, 0.0f, false, false, -0.56f, -0.42f)
                lineTo(16.0f, 4.5f)
                lineTo(8.0f, 4.5f)
                verticalLineToRelative(3.67f)
                curveToRelative(-0.2f, 0.1f, -0.4f, 0.24f, -0.56f, 0.42f)
                lineTo(6.5f, 9.65f)
                lineTo(6.5f, 4.5f)
                horizontalLineToRelative(-0.25f)
                ...
                verticalLineToRelative(-5.15f)
                lineToRelative(0.94f, 1.06f)
                curveToRelative(0.16f, 0.18f, 0.35f, 0.32f, 0.56f, 0.42f)
                verticalLineToRelative(3.67f)
