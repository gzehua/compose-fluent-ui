...
public val Icons.Regular.PhoneSpanIn: ImageVector
    get() {
        if (_phoneSpanIn != null) {
            return _phoneSpanIn!!
        }
        _phoneSpanIn = fluentIcon(name = "Regular.PhoneSpanIn") {
            fluentPath {
                moveTo(6.0f, 16.07f)
                curveToRelative(0.48f, 0.23f, 1.03f, 0.23f, 1.5f, 0.01f)
                ...
                curveToRelative(0.5f, 0.23f, 1.04f, 0.23f, 1.5f, 0.01f)
                verticalLineToRelative(3.67f)
                ...
                verticalLineToRelative(3.67f)
                arcToRelative(1.76f, 1.76f, 0.0f, false, false, -1.5f, 0.0f)
                lineTo(16.5f, 4.25f)
                curveToRelative(0.0f, -0.38f, -0.28f, -0.7f, -0.65f, -0.74f)
                lineToRelative(-0.1f, -0.01f)
                horizontalLineToRelative(-7.5f)
