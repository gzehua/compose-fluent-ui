...
public val Icons.Regular.SpeakerSettings: ImageVector
    get() {
        if (_speakerSettings != null) {
            return _speakerSettings!!
        }
        _speakerSettings = fluentIcon(name = "Regular.SpeakerSettings") {
            fluentPath {
                moveTo(14.7f, 3.44f)
                curveToRelative(0.2f, 0.23f, 0.3f, 0.51f, 0.3f, 0.81f)
                verticalLineToRelative(7.25f)
                arcToRelative(6.5f, 6.5f, 0.0f, false, false, -1.5f, 0.88f)
                ...
                arcToRelative(6.58f, 6.58f, 0.0f, false, false, 0.22f, 2.17f)
                lineTo(7.98f, 16.5f)
                lineTo(4.25f, 16.5f)
