...
public val Icons.Regular.VehicleCarProfileLtr: ImageVector
    get() {
        ...
        _vehicleCarProfileLtr = fluentIcon(name = "Regular.VehicleCarProfileLtr") {
            fluentPath {
                moveTo(5.37f, 6.03f)
                arcTo(2.75f, 2.75f, 0.0f, false, true, 8.03f, 4.0f)
                ...
                arcToRelative(1.25f, 1.25f, 0.0f, false, false, -1.07f, -0.61f)
                lineTo(11.0f, 5.5f)
