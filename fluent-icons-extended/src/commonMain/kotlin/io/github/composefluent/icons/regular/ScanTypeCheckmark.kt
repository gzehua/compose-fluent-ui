...
public val Icons.Regular.ScanTypeCheckmark: ImageVector
    get() {
        if (_scanTypeCheckmark != null) {
            return _scanTypeCheckmark!!
        }
        _scanTypeCheckmark = fluentIcon(name = "Regular.ScanTypeCheckmark") {
            fluentPath {
                moveTo(5.25f, 3.5f)
                ...
                curveToRelative(0.29f, -1.0f, 0.8f, -1.9f, 1.5f, -2.64f)
                lineTo(12.75f, 7.5f)
                horizontalLineToRelative(2.75f)
                lineTo(15.5f, 8.0f)
                arcTo(0.75f, 0.75f, 0.0f, false, false, 17.0f, 8.0f)
                lineTo(17.0f, 6.75f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, -0.75f, -0.75f)
