...
public val Icons.Regular.TextBulletListSquareWarning: ImageVector
    get() {
        if (_textBulletListSquareWarning != null) {
            return _textBulletListSquareWarning!!
        }
        _textBulletListSquareWarning = fluentIcon(name = "Regular.TextBulletListSquareWarning") {
            fluentPath {
                moveTo(5.25f, 3.0f)
                ...
                arcTo(2.5f, 2.5f, 0.0f, false, true, 17.5f, 12.0f)
                close()
                moveTo(14.34f, 15.0f)
