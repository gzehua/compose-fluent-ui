...
public val Icons.Regular.StickerAdd: ImageVector
    get() {
        if (_stickerAdd != null) {
            return _stickerAdd!!
        }
        _stickerAdd = fluentIcon(name = "Regular.StickerAdd") {
            fluentPath {
                moveTo(17.5f, 12.0f)
                ...
                close()
                moveTo(9.18f, 14.14f)
                curveToRelative(0.7f, 0.49f, 1.48f, 0.77f, 2.32f, 0.85f)
                curveToRelative(-0.19f, 0.46f, -0.33f, 0.95f, -0.42f, 1.46f)
                curveToRelative(-0.99f, -0.14f, -1.91f, -0.5f, -2.76f, -1.08f)
