...
public val Icons.Regular.VehicleShip: ImageVector
    get() {
        if (_vehicleShip != null) {
            return _vehicleShip!!
        }
        _vehicleShip = fluentIcon(name = "Regular.VehicleShip") {
            fluentPath {
                moveTo(8.75f, 2.0f)
                ...
                arcToRelative(1.75f, 1.75f, 0.0f, false, true, 1.93f, 0.58f)
                lineToRelative(-2.56f, -5.5f)
                lineToRelative(6.59f, -2.4f)
                curveToRelative(0.38f, -0.15f, 0.8f, -0.15f, 1.19f, -0.01f)
                lineToRelative(6.77f, 2.42f)
                lineToRelative(-2.62f, 5.34f)
                arcToRelative(1.75f, 1.75f, 0.0f, false, true, 1.87f, -0.4f)
                lineToRelative(2.47f, -5.04f)
