...
public val Icons.Regular.TasksApp: ImageVector
    get() {
        if (_tasksApp != null) {
            return _tasksApp!!
        }
        _tasksApp = fluentIcon(name = "Regular.TasksApp") {
            fluentPath {
                moveTo(20.0f, 4.1f)
                ...
                curveToRelative(0.1f, -0.1f, 0.22f, -0.2f, 0.34f, -0.28f)
                lineTo(20.0f, 4.1f)
                close()
                moveTo(16.28f, 22.0f)
                arcToRelative(0.7f, 0.7f, 0.0f, false, true, -0.08f, 0.0f)
                ...
                curveToRelative(-0.13f, 0.13f, -0.3f, 0.21f, -0.5f, 0.22f)
                close()
                moveTo(13.83f, 16.5f)
                lineTo(11.25f, 16.5f)
