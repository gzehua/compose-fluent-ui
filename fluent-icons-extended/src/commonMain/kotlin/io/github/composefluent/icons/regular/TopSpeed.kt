...
public val Icons.Regular.TopSpeed: ImageVector
    get() {
        if (_topSpeed != null) {
            return _topSpeed!!
        }
        _topSpeed = fluentIcon(name = "Regular.TopSpeed") {
            fluentPath {
                moveTo(6.54f, 5.48f)
                arcToRelative(8.46f, 8.46f, 0.0f, false, true, 4.71f, -1.95f)
                verticalLineToRelative(1.72f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, 1.5f, 0.0f)
                lineTo(12.75f, 3.53f)
                arcToRelative(8.5f, 8.5f, 0.0f, false, true, 7.74f, 7.97f)
                horizontalLineToRelative(-1.74f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, 0.0f, 1.5f)
                horizontalLineToRelative(1.7f)
                arcToRelative(8.45f, 8.45f, 0.0f, false, true, -3.17f, 5.67f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, 0.94f, 1.16f)
                arcTo(9.93f, 9.93f, 0.0f, false, false, 22.0f, 12.0f)
                arcToRelative(10.0f, 10.0f, 0.0f, true, false, -16.23f, 7.83f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, 0.96f, -1.16f)
                arcTo(8.66f, 8.66f, 0.0f, false, true, 3.56f, 13.0f)
                horizontalLineToRelative(1.69f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, 0.0f, -1.5f)
                lineTo(3.51f, 11.5f)
                curveToRelative(0.11f, -1.88f, 0.84f, -3.6f, 1.97f, -4.96f)
