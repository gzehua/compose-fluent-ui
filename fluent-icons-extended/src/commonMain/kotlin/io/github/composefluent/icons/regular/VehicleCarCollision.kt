...
public val Icons.Regular.VehicleCarCollision: ImageVector
    get() {
        if (_vehicleCarCollision != null) {
            return _vehicleCarCollision!!
        }
        _vehicleCarCollision = fluentIcon(name = "Regular.VehicleCarCollision") {
            fluentPath {
                moveTo(11.5f, 2.04f)
                curveToRelative(0.31f, -0.1f, 0.65f, 0.0f, 0.84f, 0.25f)
                lineTo(14.42f, 5.0f)
                lineToRelative(2.92f, -1.87f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, 1.12f, 0.87f)
                lineTo(17.3f, 7.5f)
                ...
                curveToRelative(-0.25f, -1.0f, -1.15f, -1.7f, -2.18f, -1.7f)
                lineTo(5.99f, 9.0f)
                curveToRelative(-1.08f, 0.0f, -2.0f, 0.77f, -2.2f, 1.84f)
                lineToRelative(-0.27f, 1.41f)
                ...
                curveToRelative(0.34f, 0.0f, 0.64f, 0.23f, 0.73f, 0.57f)
                lineToRelative(0.45f, 1.81f)
                lineToRelative(-0.01f, 0.12f)
                lineTo(4.9f, 13.0f)
                lineToRelative(0.36f, -1.89f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, 0.73f, -0.61f)
                close()
                moveTo(14.5f, 18.5f)
