...
public val Icons.Regular.NotepadPerson: ImageVector
    get() {
        if (_notepadPerson != null) {
            return _notepadPerson!!
        }
        _notepadPerson = fluentIcon(name = "Regular.NotepadPerson") {
            fluentPath {
                moveTo(5.75f, 22.0f)
                ...
                curveToRelative(0.1f, 0.53f, 0.3f, 1.04f, 0.62f, 1.5f)
                lineTo(5.75f, 22.0f)
                close()
                moveTo(7.25f, 16.0f)
