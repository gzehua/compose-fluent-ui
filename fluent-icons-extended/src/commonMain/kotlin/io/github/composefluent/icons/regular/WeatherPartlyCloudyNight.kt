...
public val Icons.Regular.WeatherPartlyCloudyNight: ImageVector
    get() {
        if (_weatherPartlyCloudyNight != null) {
            return _weatherPartlyCloudyNight!!
        }
        _weatherPartlyCloudyNight = fluentIcon(name = "Regular.WeatherPartlyCloudyNight") {
            fluentPath {
                moveTo(13.0f, 8.0f)
                ...
                arcTo(3.55f, 3.55f, 0.0f, false, false, 7.48f, 5.7f)
                ...
                arcTo(0.75f, 0.75f, 0.0f, false, true, 6.59f, 4.0f)
                close()
            }
        }
        return _weatherPartlyCloudyNight!!
