...
public val Icons.Regular.SaveArrowRight: ImageVector
    get() {
        if (_saveArrowRight != null) {
            return _saveArrowRight!!
        }
        _saveArrowRight = fluentIcon(name = "Regular.SaveArrowRight") {
            fluentPath {
                moveTo(3.0f, 5.75f)
                ...
                curveToRelative(-0.63f, 0.4f, -1.2f, 0.91f, -1.65f, 1.5f)
                lineTo(8.25f, 13.5f)
