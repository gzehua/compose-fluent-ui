...
public val Icons.Regular.VehicleTruckBag: ImageVector
    get() {
        if (_vehicleTruckBag != null) {
            return _vehicleTruckBag!!
        }
        _vehicleTruckBag = fluentIcon(name = "Regular.VehicleTruckBag") {
            fluentPath {
                moveTo(1.75f, 4.5f)
                ...
                arcToRelative(1.76f, 1.76f, 0.0f, false, false, -0.83f, -0.83f)
                lineTo(10.5f, 3.5f)
