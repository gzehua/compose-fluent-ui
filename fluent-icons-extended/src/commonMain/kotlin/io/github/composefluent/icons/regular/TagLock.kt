...
public val Icons.Regular.TagLock: ImageVector
    get() {
        if (_tagLock != null) {
            return _tagLock!!
        }
        _tagLock = fluentIcon(name = "Regular.TagLock") {
            fluentPath {
                moveTo(19.75f, 2.0f)
                ...
                arcToRelative(3.51f, 3.51f, 0.0f, false, false, -0.95f, -1.17f)
                lineToRelative(0.3f, -0.31f)
                curveToRelative(0.34f, -0.33f, 0.52f, -0.77f, 0.52f, -1.24f)
                lineTo(20.5f, 4.25f)
