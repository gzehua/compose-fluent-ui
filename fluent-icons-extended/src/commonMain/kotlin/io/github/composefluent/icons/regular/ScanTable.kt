...
public val Icons.Regular.ScanTable: ImageVector
    get() {
        if (_scanTable != null) {
            return _scanTable!!
        }
        _scanTable = fluentIcon(name = "Regular.ScanTable") {
            fluentPath {
                moveTo(2.75f, 15.0f)
                ...
                arcTo(2.75f, 2.75f, 0.0f, false, true, 15.42f, 18.0f)
                lineTo(8.75f, 18.0f)
                arcTo(2.75f, 2.75f, 0.0f, false, true, 6.0f, 15.42f)
                lineTo(6.0f, 8.75f)
