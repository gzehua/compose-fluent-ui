...
public val Icons.Regular.ProductionCheckmark: ImageVector
    get() {
        if (_productionCheckmark != null) {
            return _productionCheckmark!!
        }
        _productionCheckmark = fluentIcon(name = "Regular.ProductionCheckmark") {
            fluentPath {
                moveTo(6.25f, 3.5f)
                ...
                close()
                moveTo(10.5f, 16.0f)
                curveToRelative(0.0f, 0.45f, 0.2f, 0.85f, 0.51f, 1.13f)
                curveToRelative(0.05f, -0.94f, 0.3f, -1.82f, 0.7f, -2.6f)
