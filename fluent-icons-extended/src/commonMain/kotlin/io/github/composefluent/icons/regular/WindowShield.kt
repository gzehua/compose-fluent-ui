...
public val Icons.Regular.WindowShield: ImageVector
    get() {
        if (_windowShield != null) {
            return _windowShield!!
        }
        _windowShield = fluentIcon(name = "Regular.WindowShield") {
            fluentPath {
                moveTo(17.94f, 3.0f)
                ...
                arcToRelative(5.81f, 5.81f, 0.0f, false, true, -0.97f, -1.5f)
                horizontalLineTo(6.11f)
                curveToRelative(-0.9f, -0.08f, -1.61f, -0.83f, -1.61f, -1.75f)
                verticalLineTo(8.0f)
                horizontalLineToRelative(15.0f)
                verticalLineToRelative(3.89f)
                curveToRelative(0.49f, 0.4f, 0.99f, 0.62f, 1.5f, 0.72f)
                verticalLineTo(6.07f)
                arcTo(3.25f, 3.25f, 0.0f, false, false, 17.94f, 3.0f)
                close()
                moveTo(6.25f, 4.5f)
                ...
                close()
                moveTo(21.0f, 13.62f)
                arcToRelative(4.13f, 4.13f, 0.0f, false, true, -1.5f, -0.52f)
                ...
                curveToRelative(-0.2f, 0.0f, -0.4f, -0.02f, -0.6f, -0.05f)
                close()
            }
        }
        return _windowShield!!
