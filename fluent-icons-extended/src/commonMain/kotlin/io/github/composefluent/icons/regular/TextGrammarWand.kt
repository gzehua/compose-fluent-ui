...
public val Icons.Regular.TextGrammarWand: ImageVector
    get() {
        if (_textGrammarWand != null) {
            return _textGrammarWand!!
        }
        _textGrammarWand = fluentIcon(name = "Regular.TextGrammarWand") {
            fluentPath {
                moveTo(2.75f, 17.0f)
                ...
                arcToRelative(1.74f, 1.74f, 0.0f, false, true, -0.24f, -1.5f)
                lineTo(2.65f, 13.0f)
                ...
                close()
                moveTo(16.5f, 11.77f)
                arcToRelative(4.76f, 4.76f, 0.0f, false, true, -1.73f, 1.73f)
                arcToRelative(4.76f, 4.76f, 0.0f, false, true, 1.73f, 1.73f)
                arcToRelative(4.76f, 4.76f, 0.0f, false, true, 1.73f, -1.73f)
                arcToRelative(4.76f, 4.76f, 0.0f, false, true, -1.73f, -1.73f)
                close()
