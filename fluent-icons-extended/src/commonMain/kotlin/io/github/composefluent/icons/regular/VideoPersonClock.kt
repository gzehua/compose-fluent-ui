...
public val Icons.Regular.VideoPersonClock: ImageVector
    get() {
        if (_videoPersonClock != null) {
            return _videoPersonClock!!
        }
        _videoPersonClock = fluentIcon(name = "Regular.VideoPersonClock") {
            fluentPath {
                moveTo(19.75f, 3.0f)
                ...
                verticalLineToRelative(2.75f)
                lineTo(11.0f, 17.5f)
                curveToRelative(0.0f, 0.52f, 0.06f, 1.02f, 0.18f, 1.5f)
                lineTo(4.25f, 19.0f)
