...
public val Icons.Regular.VideoPersonStar: ImageVector
    get() {
        if (_videoPersonStar != null) {
            return _videoPersonStar!!
        }
        _videoPersonStar = fluentIcon(name = "Regular.VideoPersonStar") {
            fluentPath {
                moveTo(19.75f, 4.0f)
                ...
                curveToRelative(0.08f, 0.53f, 0.22f, 1.03f, 0.42f, 1.5f)
                lineTo(4.25f, 20.0f)
