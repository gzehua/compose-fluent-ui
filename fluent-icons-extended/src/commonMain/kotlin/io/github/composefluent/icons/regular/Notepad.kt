...
public val Icons.Regular.Notepad: ImageVector
    get() {
        if (_notepad != null) {
            return _notepad!!
        }
        _notepad = fluentIcon(name = "Regular.Notepad") {
            fluentPath {
                moveTo(5.75f, 22.0f)
                ...
                curveToRelative(0.0f, 0.06f, 0.0f, 0.12f, -0.02f, 0.18f)
                lineToRelative(-0.03f, 0.09f)
                lineToRelative(-0.04f, 0.1f)
                lineToRelative(-0.03f, 0.03f)
                arcToRelative(0.69f, 0.69f, 0.0f, false, true, -0.1f, 0.13f)
                lineToRelative(-4.5f, 4.5f)
                arcToRelative(0.74f, 0.74f, 0.0f, false, true, -0.09f, 0.08f)
                lineToRelative(0.09f, -0.08f)
                arcToRelative(0.74f, 0.74f, 0.0f, false, true, -0.1f, 0.1f)
