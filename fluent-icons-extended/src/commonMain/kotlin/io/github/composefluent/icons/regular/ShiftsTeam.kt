...
public val Icons.Regular.ShiftsTeam: ImageVector
    get() {
        if (_shiftsTeam != null) {
            return _shiftsTeam!!
        }
        _shiftsTeam = fluentIcon(name = "Regular.ShiftsTeam") {
            fluentPath {
                moveTo(17.75f, 3.0f)
                ...
                arcToRelative(2.98f, 2.98f, 0.0f, false, false, 0.23f, -1.5f)
                ...
                curveToRelative(-0.55f, 0.04f, -1.06f, 0.22f, -1.5f, 0.5f)
                lineTo(3.0f, 6.25f)
