...
public val Icons.Regular.PersonVoice: ImageVector
    get() {
        if (_personVoice != null) {
            return _personVoice!!
        }
        _personVoice = fluentIcon(name = "Regular.PersonVoice") {
            fluentPath {
                moveTo(14.75f, 15.0f)
                curveTo(16.0f, 15.0f, 17.0f, 16.0f, 17.0f, 17.25f)
                verticalLineToRelative(0.57f)
                curveToRelative(0.0f, 0.9f, -0.32f, 1.76f, -0.9f, 2.44f)
                curveTo(14.53f, 22.1f, 12.15f, 23.0f, 9.0f, 23.0f)
                ...
                curveTo(1.0f, 16.0f, 2.01f, 15.0f, 3.25f, 15.0f)
                ...
                curveTo(4.3f, 20.76f, 6.26f, 21.5f, 9.0f, 21.5f)
