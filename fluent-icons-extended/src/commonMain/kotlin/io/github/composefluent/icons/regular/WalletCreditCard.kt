...
public val Icons.Regular.WalletCreditCard: ImageVector
    get() {
        if (_walletCreditCard != null) {
            return _walletCreditCard!!
        }
        _walletCreditCard = fluentIcon(name = "Regular.WalletCreditCard") {
            fluentPath {
                moveTo(14.36f, 2.6f)
                ...
                lineTo(9.57f, 5.0f)
                lineTo(5.25f, 5.0f)
                curveTo(4.01f, 5.0f, 3.0f, 6.0f, 3.0f, 7.25f)
                ...
                moveTo(4.5f, 17.75f)
                lineTo(4.5f, 9.37f)
                curveToRelative(0.23f, 0.08f, 0.49f, 0.13f, 0.75f, 0.13f)
                horizontalLineToRelative(13.0f)
