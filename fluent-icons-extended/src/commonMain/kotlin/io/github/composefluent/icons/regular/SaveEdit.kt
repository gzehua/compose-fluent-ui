...
public val Icons.Regular.SaveEdit: ImageVector
    get() {
        if (_saveEdit != null) {
            return _saveEdit!!
        }
        _saveEdit = fluentIcon(name = "Regular.SaveEdit") {
            fluentPath {
                moveTo(5.75f, 3.0f)
                ...
                arcToRelative(2.26f, 2.26f, 0.0f, false, false, -0.54f, -0.06f)
                horizontalLineToRelative(-7.5f)
                curveTo(7.01f, 12.0f, 6.0f, 13.0f, 6.0f, 14.25f)
                verticalLineToRelative(5.25f)
                ...
                curveTo(7.0f, 8.49f, 8.0f, 9.5f, 9.25f, 9.5f)
                horizontalLineToRelative(4.5f)
                curveToRelative(1.24f, 0.0f, 2.25f, -1.0f, 2.25f, -2.25f)
                verticalLineTo(4.52f)
                curveToRelative(0.36f, 0.06f, 0.7f, 0.23f, 0.95f, 0.5f)
                lineTo(19.0f, 7.04f)
                curveToRelative(0.33f, 0.33f, 0.51f, 0.77f, 0.51f, 1.24f)
                verticalLineTo(10.0f)
                lineToRelative(0.21f, -0.01f)
                curveToRelative(0.44f, 0.0f, 0.88f, 0.09f, 1.29f, 0.26f)
                verticalLineTo(8.3f)
                curveToRelative(0.0f, -0.87f, -0.34f, -1.7f, -0.95f, -2.3f)
                lineTo(18.0f, 3.95f)
                arcToRelative(3.25f, 3.25f, 0.0f, false, false, -2.3f, -0.95f)
