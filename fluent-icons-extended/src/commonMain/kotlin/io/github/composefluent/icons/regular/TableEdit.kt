...
public val Icons.Regular.TableEdit: ImageVector
    get() {
        if (_tableEdit != null) {
            return _tableEdit!!
        }
        _tableEdit = fluentIcon(name = "Regular.TableEdit") {
            fluentPath {
                moveTo(3.0f, 6.25f)
                ...
                arcToRelative(3.3f, 3.3f, 0.0f, false, false, -1.5f, 0.22f)
                lineTo(19.5f, 10.0f)
                ...
                close()
                moveTo(19.76f, 12.2f)
                arcToRelative(2.27f, 2.27f, 0.0f, false, false, -0.66f, 0.47f)
                lineToRelative(-5.9f, 5.9f)
                arcToRelative(2.68f, 2.68f, 0.0f, false, false, -0.71f, 1.25f)
                ...
                lineToRelative(5.9f, -5.9f)
                arcToRelative(2.29f, 2.29f, 0.0f, false, false, -2.57f, -3.7f)
                close()
            }
        }
        return _tableEdit!!
